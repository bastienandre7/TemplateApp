          ...
          <div className="hidden lg:flex items-center space-x-4 rtl:space-x-reverse">
            <NavigationMenu viewport={false}>
              <NavigationMenuList>
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger>
                    <Link href="/nextjs-templates">Templates</Link>
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-1 md:w-[600px] md:grid-cols-2">
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[300px] gap-4">
                      <li>
                        ...
                        <NavigationMenuLink asChild>
                          <Link href="/license">
                            <div className="text-base">License</div>
                            <div className="text-muted-foreground">
...
function ListItem({
  ...
  return (
    <li {...props}>
      ...
      >
        {icon && (
          <span className="flex items-center justify-center shrink-0 p-2 bg-black/5 rounded-md">
