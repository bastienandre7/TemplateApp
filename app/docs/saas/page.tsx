...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://bloomtpl.com/docs/saas",
  },
};

export default function SaasTemplateDocsPage() {
  return (
    <main className="bg-background pt-32 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-6 text-gray-700">
          ...
          SaaS template built with Next.js 15, Tailwind CSS, shadcn/ui, Prisma,
          NextAuth, and Stripe.
        </p>
        ...
        <section className="mb-10">
          ...
          <ol className="list-decimal list-inside space-y-4 text-gray-700">
            ...
            <li>
              ...
              database, authentication, and Stripe keys.
              <pre className="bg-gray-100 rounded p-2 mt-2 mb-2 text-sm">
                <code>cp .env.example .env</code>
              </pre>
              <ul className="list-disc list-inside ml-6 text-gray-700">
                <li>
                  <code>DATABASE_URL</code> – Your PostgreSQL or MySQL
                  connection string
                </li>
                <li>
                  <code>NEXTAUTH_SECRET</code> – A random string for NextAuth
                </li>
                <li>
                  <code>STRIPE_SECRET_KEY</code> – Your Stripe secret key
                </li>
                <li>
                  <code>STRIPE_PUBLIC_KEY</code> – Your Stripe public key
                </li>
                {/* Ajoute les autres variables nécessaires */}
              </ul>
            </li>
            <li>
              <strong>Set up the database:</strong> Run Prisma migrations to
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-4 text-gray-700">
            ...
            <li>
              <strong>Update authentication:</strong> Configure NextAuth
              providers in <code>/app/api/auth/[...nextauth]/route.ts</code> and
              update the sign-in page as needed.
            </li>
            <li>
              <strong>Update Stripe integration:</strong> Edit Stripe keys in{" "}
              <code>.env</code> and customize payment logic in{" "}
              <code>/app/api/</code> and related components.
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-4 text-gray-700">
            ...
            <li>
              <strong>Run database migrations:</strong> On your server, run:
              <pre className="bg-gray-100 rounded p-2 mt-2 mb-2 text-sm">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-4 text-gray-700">
            ...
            <li>
              For NextAuth configuration, see the{" "}
              <a
            ...
            <li>
              For Stripe integration, see the{" "}
              <a
