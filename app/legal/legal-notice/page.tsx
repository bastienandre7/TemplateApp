...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://bloomtpl.com/legal/legal-notice",
  },
  openGraph: {
    title: "Legal Notice – BloomTPL",
    description:
      "Find legal details, copyright ownership, and contact information regarding the BloomTPL brand, website, and all template-related content and assets.",
    url: "https://bloomtpl.com/legal/legal-notice",
    siteName: "BloomTPL",
    locale: "en_US",
    type: "website",
    images: [
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 text-gray-800">
          <section id="english">
            ...
            <p className="mb-16">
              ...
              Charter&quot;, in accordance with Regulation (EU) 2016/679 of
              April 27, 2016 (GDPR).
            </p>
          </section>
          ...
          <section id="french">
            ...
            <p className="mb-4">
              ...
              précisé aux utilisateurs du site BloomTPL l&apos;identité des
            ...
            <p className="mb-4">
              ...
              Sociétés (RCS) de Paris sous le numéro{" "}
              <strong>943 199 257</strong>.
            </p>
            ...
            <p className="mb-4">
              ...
              Ave Pmb 4133 Covina, CA, 91723-1722 United States, (contact via
              https://vercel.com/help).
            </p>
