      ...
      <div className="bg-background">
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 text-gray-800">
          <section id="english">
            ...
            <ul className="mb-4">
              <li>
                - How their personal data is collected. Personal data includes
                any information that can identify a user: their name, age,
                postal or email address, location, or IP address (non-exhaustive
                list);
              </li>
              <li>- The rights they have regarding this data;</li>
              <li>
                - The person responsible for processing the collected and
                processed personal data;
              </li>
              <li>- The recipients of this personal data;</li>
            ...
            <h2 className="text-2xl font-bold mb-4">
              ARTICLE 2: PRINCIPLES REGARDING DATA COLLECTION AND PROCESSING
            </h2>

            <p className="mb-4">
              In accordance with Article 5 of the European Regulation 2016/679,
              personal data must be:
            </p>

            <li className="mb-4">
              Processed lawfully, fairly, and transparently for the data
              subject;
            </li>
            <li className="mb-4">
              Collected for specified, explicit, and legitimate purposes (see
              Article 3.1), and not further processed in a way incompatible with
              those purposes;
            </li>
            <li className="mb-4">
            ...
            <li className="mb-4">
              Accurate and kept up to date. All reasonable steps must be taken
              to ensure that inaccurate data are erased or rectified without
              delay;
            </li>
            <li className="mb-4">
              Kept in a form that permits identification of data subjects for no
              longer than necessary for the purposes for which they are
              processed;
            </li>
            <li className="mb-4">
            ...
            <li className="mb-4">
              Processing is necessary to protect vital interests of the data
              subject or another person;
            </li>
            <li className="mb-4">
              Processing is necessary for a task in the public interest or
              official authority vested in the controller;
            </li>
            <li className="mb-4">
              Processing is necessary for the legitimate interests pursued by
              the controller or a third party, unless such interests are
              overridden by the data subject’s fundamental rights and freedoms,
              especially if the data subject is a child.
            </li>

            <h2 className="text-2xl font-bold mb-4">
              ARTICLE 3: PERSONAL DATA COLLECTED AND PROCESSED WHILE BROWSING
              THE SITE
            </h2>
            ...
            <p className="mb-4">
              The personal data collected as part of our activity are:
            </p>

            <li>Full name</li>
            <li>Email address</li>
            <li>IP address</li>
            <li className="mb-4">Purchase history</li>

            <p className="mb-4">
              The purposes of data collection and processing are:
            </p>

            <li>Ensure proper functioning of the order and delivery service</li>
            <li>
              Send notifications related to purchases (download links, invoices,
              etc.)
            </li>
            <li>Manage access to the customer dashboard</li>
            <li className="mb-4">
              Improve user experience and customer support
            </li>

            <h2 className="text-lg font-bold mb-4">
              Article 3.2: Method of Collection
            </h2>

            <p className="mb-4">
              When you use our site, the following data are automatically
              collected:
            </p>

            <li>IP address</li>
            <li>Technical data related to browser and operating system</li>
            <li>Pages visited and browsing duration</li>
            <li>Referrer (URL you came from)</li>
            <li className="mb-4">Approximate location (via IP address)</li>

            <p className="mb-4">
              Other data are collected when you perform the following actions:
            </p>

            <li>
              When placing an order: first and last name, email address, billing
              information
            </li>
            <li>When attempting to log in: email address</li>
            <li className="mb-4">
              When using the contact form: email address, name, subject, message
            </li>

            <p className="mb-4">
              These data are retained securely for a maximum of 3 years from the
              last contact or activity.
            </p>

            <p className="mb-4">
              The company may retain some personal data beyond the periods
              indicated to fulfill legal or regulatory obligations (e.g., tax,
            ...
            <p className="mb-4">The BloomTPL site is hosted by:</p>
            <p className="mb-4">
              Vercel Inc., 440 N Barranca Ave Pmb 4133 Covina, CA, 91723-1722
              United States (contact via https://vercel.com/help).
            </p>
            ...
            <p className="mb-4">The site may use &quot;cookies&quot;.</p>
            <p className="mb-4">
              A cookie is a small file stored in your browser during your visit
              that does not allow identification but records information about
              your browsing (pages viewed, duration, approximate location,
              etc.).
            </p>
            ...
            <p className="mb-4">
              You can configure your browser to disable cookies at any time.
              Upon your first visit to the site, a banner also allows you to
            ...
            <p className="mb-4">
              Personal data is collected by Bastien André, sole trader,
              registered with the Paris Trade and Companies Register (RCS) under
              number 943 199 257, whose head office is located at 200 rue de la
              Croix Nivert, 75015, Paris, France.
            </p>
            ...
            <li>By mail: 200 rue de la Croix Nivert, 75015, Paris, France</li>
            <li>By phone: +33615682296</li>
            <li className="mb-4">By email: bloomtpl@gmail.com</li>
            ...
            <p className="mb-4">
              Bastien Andre; 200 rue de la Croix Nivert, 75015, Paris, France;
              bloomtpl@gmail.com
            </p>
            <p className="mb-4">
              If you believe your “Data Protection” rights are not respected,
              you can contact the CNIL.
            </p>

            <h2 className="text-2xl font-bold mb-4">ARTICLE 5: USER RIGHTS</h2>

            <p className="mb-4">
              Any user whose personal data is processed may assert the following
              rights, according to the GDPR and the French Data Protection Act
              (Law 78-17 of January 6, 1978):
            </p>

            <li>
              Right of access, rectification, and deletion (Articles 15, 16, and
              17 of the GDPR)
            </li>
            <li>Right to data portability (Article 20 of the GDPR)</li>
            <li>
              Right to restriction and objection to data processing (Articles 18
              and 21 of the GDPR)
            </li>
            ...
            <p className="mb-4">
              To exercise your rights, contact Bastien Andre, 200 rue de la
              Croix Nivert, 75015, Paris, France or by email at
              bloomtpl@gmail.com
            </p>

            <p className="mb-4">
              The controller may require information to verify your identity:
              name, email address, account or subscriber ID.
            </p>
            ...
            <h2 className="text-2xl font-bold mb-4">
              ARTICLE 6: POLICY MODIFICATIONS
            </h2>

            <p className="mb-4">
              The BloomTPL site editor reserves the right to modify this policy
              at any time to ensure compliance with current laws.
            </p>

            <p className="mb-4">
              These changes will not affect previous purchases, which remain
              subject to the version accepted at the time of purchase.
            </p>

            <p className="mb-4">
              Users are encouraged to consult this policy regularly, without
              prior notification.
            </p>

            <p className="mb-16">
              This policy was created and last updated on April 14, 2025.
            </p>
          </section>
          ...
          <section id="french">
            ...
            <ul className="mb-4">
              <li>
                ...
                personnelles. Sont considérées comme des données personnelles,
                toute information permettant d’identifier un utilisateur. A ce
                titre, il peut s’agir : de ses noms et prénoms, de son âge, de
                son adresse postale ou email, de sa localisation ou encore de
                son adresse IP (liste non-exhaustive) ;
              </li>
              <li>
            ...
            <li>Adresse IP</li>
            <li className="mb-4">Historique des achats</li>
            ...
            <li>
              Assurer le bon fonctionnement du service de commande et de
              livraison
            </li>
            <li>
              Envoyer des notifications liées aux achats (liens de
              téléchargement, factures, etc.)
            </li>
            <li>Gérer l’accès au tableau de bord client</li>
            <li className="mb-4">
              Améliorer l’expérience utilisateur et le support client
            </li>
            ...
            <li>Référent (URL depuis laquelle vous êtes arrivé)</li>
            <li className="mb-4">
            ...
            <li>
              Lors d’une commande : prénom, nom, adresse e-mail, informations de
              facturation
            </li>
            <li>Lors d’une tentative de connexion : adresse e-mail</li>
            <li className="mb-4">
              Lors d’une demande via le formulaire de contact : adresse e-mail,
              nom, objet, message
            </li>
            ...
            <p className="mb-4">
              ...
              maximum à compter du dernier contact ou de la dernière activité
              sur la plateforme.
            </p>
            ...
            <p className="mb-4">
              ...
              remplir ses obligations légales ou réglementaires (ex. :
              obligations fiscales, litiges, prévention de la fraude).
            </p>
            ...
            <p className="mb-4">Le site BloomTPL est hébergé par :</p>
            <p className="mb-4">
              Vercel Inc., 440 N Barranca Ave Pmb 4133 Covina, CA, 91723-1722
              United States, (contact via https://vercel.com/help).
            </p>
            ...
            <p className="mb-4">
              Le site peut avoir recours aux techniques de “cookies”.
            </p>
            <p className="mb-4">
              Un cookie est un petit fichier déposé sur votre navigateur lors de
              votre visite, qui ne permet pas votre identification, mais qui
              enregistre des informations relatives à votre navigation (pages
              visitées, durée, localisation approximative, etc.).
            </p>
            <p className="mb-4">L’utilisation des cookies sert notamment à :</p>

            <li>Mesurer l’audience du site via Vercel Analytics</li>
            <li>Améliorer l’expérience utilisateur (panier, préférences)</li>
            <li className="mb-4">
              Sécuriser les sessions utilisateurs (authentification)
            </li>

            <p className="mb-4">
              Vous pouvez configurer votre navigateur pour désactiver les
              cookies à tout moment. Lors de votre première visite sur le site,
              une bannière vous permet également d’accepter ou de refuser
            ...
            <p className="mb-4">
              Les données à caractère personnel sont collectées par Bastien
              André, micro-entrepreneur, immatriculé au Registre du Commerce et
              des Sociétés (RCS) sous le numéro 943 199 257, dont le siège
              social est situé à 200 rue de la Croix Nivert, 75015, Paris,
              France.
            </p>
            ...
            <li>
              Par courrier à l’adresse : 200 rue de la Croix Nivert, 75015,
              Paris, France ;{" "}
            </li>
            <li>Par téléphone, au 0615682296 ; </li>
            <li className="mb-4">Par mail : bloomtpl@gmail.com</li>
            ...
            <p className="mb-4">
              ...
              du règlement européen 2016/679 et de la Loi Informatique et
            ...
            <p className="mb-4">
              ...
              Bastien Andre 200 rue de la Croix Nivert, 75015, Paris, France ou
              par mail à bloomtpl@gmail.com
            </p>
            ...
            <p className="mb-4">
              L’éditeur du site BloomTPL se réserve le droit de pouvoir modifier
              la présente Politique à tout moment afin d’assurer aux
              utilisateurs du site sa conformité avec le droit en vigueur.
            </p>

            <p className="mb-4">
              Les éventuelles modifications ne sauraient avoir d’incidence sur
              les achats antérieurement effectués sur le site, lesquels restent
            ...
            <p className="mb-4">
              La présente politique, éditée le 14/04/2025, a été mise à jour le
              14/04/2025.
            </p>
          </section>
        </div>
